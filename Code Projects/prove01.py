...
city = input("Two more questions, what city or place do you recommend to live at? \n")
miles = input(f"How far is {city} from here in miles? (Enter a number please)\n")
miles = int(miles)
print(f"Thats just over younder an\'t it, at exactly {miles} miles.")
